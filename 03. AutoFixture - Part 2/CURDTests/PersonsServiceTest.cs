...
public class PersonsServiceTest
{
   ...
   [Fact]
   public async Task AddPerson_ProperPersonDetailsAsync()
   {
      //Arrange
      ...
      // Instead of hard coding the PersonAddRequest data, we can use AutoFixture to generate the test data
      //PersonAddRequest? personAddRequest = _fixture.Create<PersonAddRequest>();
      // Create is initializing all properties with random data as default data format
      PersonAddRequest? personAddRequest = _fixture.Build<PersonAddRequest>()
                                                   .With(x => x.Email, "someone@gmail.com")
                                                   .Create();
